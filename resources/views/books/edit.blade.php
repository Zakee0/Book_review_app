            ...
            <div class="card border-0 shadow">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{ old('title',$book->title) }}"  class="form-control @error('title') is-invalid
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{ old('author',$book->author) }}"  class="form-control @error('author') is-invalid
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                        @if (!empty($book->image))
                        <img class="w-25 my-2" src="{{ asset('uploads/books/'. $book->image) }}" alt="">
