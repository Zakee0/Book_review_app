<div class="card border-0 shadow-lg">
    ...
    <div class="card-body">
        <div class="text-center mb-3">
            @if (Auth::user()->image != '')
                <img src="{{ asset('uploads/profile/' . Auth::user()->image) }}" class="img-fluid "
                    style="max-width: 150px; max-height: 150px;" alt="Luna John">
            @endif
    ...
    <div class="card-body sidebar">
        ...
        <ul class="nav flex-column">
            @if (Auth::user()->role == 'admin')
                ...
                <li class="nav-item">
                    <a href="{{ route('account.review') }}">Reviews</a>
                </li>
            @endif
